...
%% definition,in module megaco_ber_media_gateway_control_v1



-ifndef(_MEGACO_BER_MEDIA_GATEWAY_CONTROL_V1_HRL_).
-define(_MEGACO_BER_MEDIA_GATEWAY_CONTROL_V1_HRL_, true).
...
serviceChangeMethod, serviceChangeAddress = asn1_NOVALUE, serviceChangeVersion = asn1_NOVALUE, serviceChangeProfile = asn1_NOVALUE, serviceChangeReason, serviceChangeDelay = asn1_NOVALUE, serviceChangeMgcId = asn1_NOVALUE, timeStamp = asn1_NOVALUE, nonStandardData = asn1_NOVALUE}). % with extension mark

-record('DigitMapValue',{
startTimer = asn1_NOVALUE, shortTimer = asn1_NOVALUE, longTimer = asn1_NOVALUE, digitMapBody}). % with extension mark
...
requestID, eventList}). % with extension mark
...
auditToken = asn1_NOVALUE}). % with extension mark
...
-endif. %% _MEGACO_BER_MEDIA_GATEWAY_CONTROL_V1_HRL_
