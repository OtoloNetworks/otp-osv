...
%% definition,in module megaco_ber_media_gateway_control_v2



-ifndef(_MEGACO_BER_MEDIA_GATEWAY_CONTROL_V2_HRL_).
-define(_MEGACO_BER_MEDIA_GATEWAY_CONTROL_V2_HRL_, true).
...
-endif. %% _MEGACO_BER_MEDIA_GATEWAY_CONTROL_V2_HRL_
