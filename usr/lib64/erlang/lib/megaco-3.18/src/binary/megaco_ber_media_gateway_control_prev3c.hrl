...
%% definition,in module megaco_ber_media_gateway_control_prev3c



-ifndef(_MEGACO_BER_MEDIA_GATEWAY_CONTROL_PREV3C_HRL_).
-define(_MEGACO_BER_MEDIA_GATEWAY_CONTROL_PREV3C_HRL_, true).
...
-endif. %% _MEGACO_BER_MEDIA_GATEWAY_CONTROL_PREV3C_HRL_
