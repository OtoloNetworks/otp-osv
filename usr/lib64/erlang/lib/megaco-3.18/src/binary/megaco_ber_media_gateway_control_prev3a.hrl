...
-ifndef(_MEGACO_BER_MEDIA_GATEWAY_CONTROL_PREV3A_HRL_).
-define(_MEGACO_BER_MEDIA_GATEWAY_CONTROL_PREV3A_HRL_, true).
...
-endif. %% _MEGACO_BER_MEDIA_GATEWAY_CONTROL_PREV3A_HRL_
