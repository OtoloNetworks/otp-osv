...
%% definition,in module megaco_per_media_gateway_control_prev3b



-ifndef(_MEGACO_PER_MEDIA_GATEWAY_CONTROL_PREV3B_HRL_).
-define(_MEGACO_PER_MEDIA_GATEWAY_CONTROL_PREV3B_HRL_, true).
...
-endif. %% _MEGACO_PER_MEDIA_GATEWAY_CONTROL_PREV3B_HRL_
