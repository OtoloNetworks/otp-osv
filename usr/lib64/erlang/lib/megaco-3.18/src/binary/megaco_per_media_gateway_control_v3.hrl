...
%% definition,in module megaco_per_media_gateway_control_v3



-ifndef(_MEGACO_PER_MEDIA_GATEWAY_CONTROL_V3_HRL_).
-define(_MEGACO_PER_MEDIA_GATEWAY_CONTROL_V3_HRL_, true).
...
-endif. %% _MEGACO_PER_MEDIA_GATEWAY_CONTROL_V3_HRL_
