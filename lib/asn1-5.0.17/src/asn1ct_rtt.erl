...
assert_defined({ext,transform_to_EXTERNAL1990_maps,1}) -> ok;
assert_defined({ext,transform_to_EXTERNAL1994,1}) -> ok;
assert_defined({ext,transform_to_EXTERNAL1994_maps,1}) -> ok;
assert_defined({jer,decode_jer,3}) -> ok;
assert_defined({jer,encode_jer,3}) -> ok;
...
[{ext,transform_to_EXTERNAL1990,2}];
dependencies({jer,bitstring2json,1}) ->
[{jer,octetstring2json,1}];
dependencies({jer,decode_jer,2}) ->
[{jer,decode_jer,2},
 ...
 {jer,json2oid,1}];
dependencies({jer,decode_jer,3}) ->
[{jer,decode_jer,2}];
dependencies({jer,decode_jer_component,3}) ->
[{jer,decode_jer,2},{jer,decode_jer_component,3}];
dependencies({jer,encode_bitstring,1}) ->
[{jer,encode_bitstring,2},{jer,unused_bitlist,2}];
dependencies({jer,encode_bitstring,2}) ->
[{jer,unused_bitlist,2}];
dependencies({jer,encode_jer,2}) ->
[{jer,bitstring2json,1},
 ...
 {jer,jer_padbitstr,2},
 {jer,oid2json,1}];
dependencies({jer,encode_jer,3}) ->
[{jer,encode_jer,2}];
dependencies({jer,encode_jer_component,3}) ->
[{jer,encode_jer,2},{jer,encode_jer_component,3}];
dependencies({jer,encode_jer_component_tab,4}) ->
[{jer,encode_jer,2},{jer,encode_jer_component_tab,4}];
dependencies({jer,jer_bit_str2bitstr,2}) ->
[{jer,jer_compact2bitstr,1},{jer,jer_do_encode_named_bit_string,2}];
dependencies({jer,jer_bitstr2names,2}) ->
[{jer,jer_bitstr2names,4}];
dependencies({jer,jer_bitstr2names,4}) ->
[{jer,jer_bitstr2names,4}];
dependencies({jer,jer_compact2bitstr,1}) ->
[{jer,jer_int2bitstr,1},{jer,jer_skip_trailing_zeroes,2}];
dependencies({jer,jer_do_encode_named_bit_string,2}) ->
[{jer,encode_bitstring,1},
 {jer,jer_get_all_bitposes,3},
 {jer,jer_make_and_set_list,3}];
dependencies({jer,jer_get_all_bitposes,3}) ->
[{jer,jer_get_all_bitposes,3}];
dependencies({jer,jer_int2bitstr,1}) ->
[{jer,jer_int2bitstr,2}];
dependencies({jer,jer_make_and_set_list,3}) ->
[{jer,jer_make_and_set_list,3}];
dependencies({jer,jer_skip_trailing_zeroes,2}) ->
[{jer,jer_skip_trailing_zeroes,2}];
dependencies({jer,json2bitstring,2}) ->
[{jer,json2bitstring,3}];
dependencies({jer,json2octetstring2binary,1}) ->
[{jer,json2octetstring,2}];
dependencies({jer,json2octetstring2string,1}) ->
[{jer,json2octetstring,2}];
dependencies({jer,oid2json,1}) ->
[{jer,oid2json,2}];
dependencies({jer,oid2json,2}) ->
[{jer,oid2json,2}];
